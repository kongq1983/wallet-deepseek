...
- **Form fields:** `references/form-specification.md` — when scenarios involve form creation or editing (create/update entities with user input), define form field specs (control type, required, constraints), standard fill steps, validation coverage rules, and unified error messages
